    ...
    while (fgets(buffer, sizeof(buffer), file) != NULL) {
        ...
        for (int i = 0; i < row; i++) {
            ...
            if (orderserch(word[i], move_list, move_list_size, "move", token))
                ...
                ;
            else if (orderserch(word[i], shift_list, shift_list_size, "shift",
                                token))
                ;
            else if (orderserch(word[i], rotate_list, rotate_list_size,
                                "rotate", token))
                ;
                ...
                ;
            else if (orderserch(word[i], swap_list, swap_list_size, "swap",
                                token))
                ;
            else if (orderserch(word[i], exg_list, exg_list_size, "exg", token))
                ;
            else if (orderserch(word[i], dbcc_list, dbcc_list_size, "dbcc",
                                token))
                ;
                ...
                ;
            else if (orderserch(word[i], return_list, return_list_size, "rts",
                                token))
                ;
...
void orderlist(char *token, char **word, char *output) {
    ...
    switch (tokenn) {
        case MOVE:
            MOVEn((char **)word, output);
            break;
        case LSR:
            LSRn((char **)word, output);
            break;
        case ASL:
            ASLn((char **)word, output);
            break;
        case ASR:
            ASRn((char **)word, output);
            break;
        case ROL:
            ROLn((char **)word, output);
            break;
        case ROR:
            RORn((char **)word, output);
            break;
        case RCL:
            RCLn((char **)word, output);
            break;
        case RCR:
            RCRn((char **)word, output);
            break;
        case ADD:
            ADDn((char **)word, output);
            break;
        case SUBA:
            SUBAn((char **)word, output);
            break;
        case SUBS:
            SUBSn((char **)word, output);
            break;
        case OR:
            ORn((char **)word, output);
            break;
        case AND:
            ANDn((char **)word, output);
            break;
        case NOT:
            NOTn((char **)word, output);
            break;
        case XOR:
            XORn((char **)word, output);
            break;
        case XNOR:
            XNORn((char **)word, output);
            break;
        case PUSH:
            PUSHn((char **)word, output);
            break;
        case POP:
            POPn((char **)word, output);
            break;
        case MOVEC:
            MOVECn((char **)word, output);
            break;
        case MOVNC:
            MOVNCn((char **)word, output);
            break;
        case JMP:
            // PC → %d5
        ...
        case BRA:
            ...
            break;
        case BEQ:
            BEQn((char **)word, output);
            break;
        case BNE:
            BNEn((char **)word, output);
            break;
        case RTS:
            RTSn((char **)word, output);
            break;
        case CMP:
            CMPn((char **)word, output);
            break;
        case PEA:
            PEAn((char **)word, output);
            break;
        default:
